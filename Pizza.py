...
bot = telebot.TeleBot("6293737496:AAExPWTNB9vcSKr9YQfHl5433V6zvZYy3GE")


@bot.message_handler(commands=['start'])
def send_welcome(message):
    bot.reply_to(message, "Здравствуйте! Как вас зовут?")
...
def get_pizza(message, name):
    ...
    bot.reply_to(message, "Как вы будете платить, наличными или картой?", reply_markup=create_payment_buttons())
...
def get_payment(message, name, pizza_size):
    ...
    bot.reply_to(message, "Какой у вас адрес доставки?")
